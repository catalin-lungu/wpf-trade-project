...
namespace KmK_Business.RTF
{
    ...
    public class HtmlParser
    {
        ...
        public const string BaseHtmlHeader = "<html>";
        public const string BaseHtmlFooter = "</html>";
        public const string BaseHtmlBodyHeader = "<body>";
        public const string BaseHtmlBodyFooter = "</body>";
        public const string BaseHtmlDivHeader = "<div>";
        public const string BaseHtmlDivFooter = "</div>";
        public const string BaseHtmlInfoString = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\"><HTML><HEAD><META http-equiv=Content-Type content=\"text/html; charset=utf-8\"><META content=\"MSHTML 6.00.6000.16788\" name=GENERATOR></HEAD>";
