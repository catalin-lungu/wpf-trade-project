...
using System.Windows.Markup; // TextElement
...
namespace KmK_Business.RTF
{
    ...
    public static class HtmlToXamlConverter
    {
        ...
        /// </returns>
        public static FlowDocument ConvertHtmlToXaml(string htmlString)
        {
            return DeserializeFlowDocument(ConvertHtmlToXaml(htmlString, true));
        }
        ...
        {
            /*
             <Image Source="file:///C:/Documents and Settings/david.stindl/Local Settings/Temporary Internet Files/Content.IE5/YNJ5MMZL/cetelem_logo_cl_small[1].gif" 
                    Width="150" Height="59" InputMethod.IsInputMethodEnabled="True" />
             */
            // Create Image element
            XmlElement xamlImageElement = xamlParentElement.OwnerDocument.CreateElement(null, Xaml_Image, _xamlNamespace);

            XmlAttribute xmlAttrib = htmlElement.Attributes["src"];
            if (null != xmlAttrib)
            {
                xamlImageElement.SetAttribute("Source", xmlAttrib.Value);
            }
            xamlParentElement.AppendChild(xamlImageElement);
        }
